...
class ENet(nn.Module):
    """Constructs a ENet model.

    PyTorch implementation of ENet:
    - Paper: https://arxiv.org/abs/1606.02147
    - GitHub repo: https://github.com/e-lab/ENet-training
...
class InitialBlock(nn.Module):
    """Constructs the initial block from the ENet architecture.
...
class RegularBottleneck(nn.Module):
    """Constructs regular bottlenecks, the main building block of ENet.
    ...
    projection_ratio, also called a projection;
    ...
    Arguments:
        ...
        projection_ratio (int, optional): a scale factor applied to channels
            to reduce the number of channels, and therefore, computation cost.
            eg. given channels equal to 128 and projection_ratio equal to 2, the number
            of channels after the projection convolution is 64. Default: 4.
        kernel_size (int, optional): the kernel size of the filters used in
    ...
    def __init__(
        ...
        internal_channels = channels // projection_ratio
...
class DownsamplingBottleneck(nn.Module):
    """Constructs downsampling bottlenecks.
    ...
    by projection_ratio, also called a projection;
    ...
    Arguments:
        ...
        projection_ratio (int, optional): a scale factor applied to in_channels
            to reduce the number of channels, and therefore, computation cost.
            eg. given channels equal to 128 and projection_ratio equal to 2, the number
            of channels after the projection convolution is 64. Default: 4.
        kernel_size (int, optional): the kernel size of the filters used in
        ...
        bias (bool, optional): Adds a learnable bias to the output if
            True. Default: False.
        relu (bool, optional): When True ReLU is used as the activation function;
            otherwise, PReLU is used. Default: True.
    ...
    def __init__(
        ...
        internal_channels = in_channels // projection_ratio
        self.ext_conv1 = nn.Sequential(
            nn.Conv2d(
...
class UpsamplingBottleneck(nn.Module):
    """Constructs upsampling bottlenecks.

    Upsample the feature map resolution using max pooling indices stored from the
